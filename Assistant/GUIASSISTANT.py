...
#########################
ai_name = 'PIXELCHAT'.lower()
EXIT_COMMANDS = ['bye','exit','quit','shut down', 'shutdown']

ownerName = "Byte Battallion"
...
ass_voiceRate = 100 #normal voice rate
...
def main(text):
		if 'partner' in text:
			speak("Here are the results "+ownerDesignation, True)
			webScrapping.openWebsite('https://www.codilar.com/partners/')
			return
		if 'volume' in text:
		...
		if 'career' in text:
			speak("Here are the results "+ownerDesignation, True)
			webScrapping.openWebsite('https://www.codilar.com/career/')
			return
		if 'life at codilar' in text:
			speak("Here are the results "+ownerDesignation, True)
			webScrapping.openWebsite('https://www.codilar.com/career/')
			return
		if 'contact' in text:
			speak("Here are the results "+ownerDesignation, True)
			webScrapping.openWebsite('https://www.codilar.com/contact/')
			return
		if 'services' in text:
			speak("Our services are Magento Development,Magento 2 migration,PWA for Magento,Magento Audit,Adobe Commerce Development"+ownerDesignation, True)
			return
		if 'events' in text:
			speak("Here are the results "+ownerDesignation, True)
			webScrapping.openWebsite('https://www.codilar.com/events/')
			return
		if 'images' in text:
			speak("Here are the results "+ownerDesignation, True)
			webScrapping.openWebsite('https://www.codilar.com/events/')
		...
		if 'whatsapp' in text:
			...
			WAEMPOPUP("WhatsApp", "Phone Number:9605511403")
...
if __name__ == '__main__':
	...
	#User and Bot Icon
	userIcon = PhotoImage(file="extrafiles/images/a1.png")
	botIcon = PhotoImage(file="extrafiles/images/icon.png")
